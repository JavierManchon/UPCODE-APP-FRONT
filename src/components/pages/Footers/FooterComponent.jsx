        ...
        <div className='container-pages-default-styles'>
            ...
            <div className='container-renderized_html'>
                ...
                <div id='html' className='html'>
                    <span>{'<'}{template.elementType}{' class="'}{template.defaultStyles[0]}{'"'}{'>'}</span>
                    <span>{'<'}{template.defaultContent ? template.defaultContent.children : null}{' class="'}{template.defaultStyles[1]}{'"'}{'>'}</span>
                    {Array.from({ length: template.defaultContent.count }).map((_, index) => (
                    <React.Fragment key={index}>
                        <span> 
                            {'<' + (template.defaultContent ? template.defaultContent.items : null) + ' class="' + (template.defaultStyles[2]) + '">'}
                            {aTag ? '<a href="">' : null}
                            {liValues[index]}
                            {aTag ? '</a>' : null}
                            {'</' + (template.defaultContent ? template.defaultContent.items : null) + '>'}
